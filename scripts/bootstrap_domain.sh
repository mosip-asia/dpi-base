...
echo ""
echo "👉 NEXT STEPS FOR GITOPS FOUNDATION:"
echo "1. Switch to your management Terraform directory:"
echo "     cd ${TARGET_TF_REL}"
echo "2. Initialize Terraform (direct GCS backend):"
echo "     terraform init -backend-config=\"bucket=${BUCKET_NAME}\""
echo "3. Review plan and apply:"
echo "     terraform apply"
echo "4. Delegate NS records in parent DNS zone (ait-brainlab-mgmt):"
