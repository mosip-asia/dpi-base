...
# The operating admins also read the shared Google OAuth client, which Rancher's SSO
# form needs typed in once (agreed with akraradets on 2026-09-18, issue #5).
